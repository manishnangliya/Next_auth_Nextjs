        ...
        <div className='min-h-screen bg-gray-100 flex items-center justify-center'>
            <div className='bg-white p-8 rounded shadow-md w-96'>
                ...
                <form onSubmit={handleRegister}>
                    <div className='mb-4'>
                        <div className='mb-4'>
                            <label htmlFor='username' className='black text-gray-700 text-sm font-bold mb-2'> Username</label>
                        ...
                        <div className='mb-4'>
                            <label htmlFor='password-confirm' className='black text-gray-700 text-sm font-bold mb-2'> Confirm Password</label>
                            <input type='password' id='password-confirm' name='password-confirm' className='w-full p-2 border border-gray-300 rounded' />
                        </div>
                        <div>
                            <button type='submit' className='mb-5 w-full bg-blue-500 text-white py-2 rounded hover:bg-blue-600'>Register Now</button>
                        </div>
                        <span>
                            {" "}
